...
class ProductsAdapter(
...
) : BaseAdapter<Products, ProductsAdapter.ViewHolder>(productsInfos, productsClickListener) {
    class ViewHolder(
    ...
    override fun onBindViewHolder(
        ...
        bindTextView(holder.binding.textView2, product?.name ?: "")
        bindTextView(holder.binding.textView3, "Fiyat:" + product?.price.toString() + "\n")
        bindTextView(
            holder.binding.textView4,
            DecimalFormat("#.##").format(product?.score).toString(),
        )
        ...
        holder.binding.root.setOnClickListener {
            productsClickListener.onProductClicked(
                ...
                productScoreCount = product?.scoreCount,
            )
        }
    }
